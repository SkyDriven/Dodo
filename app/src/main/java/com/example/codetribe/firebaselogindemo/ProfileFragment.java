...
public class ProfileFragment  extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        counrty.setVisibility(View.GONE);
        ...
        id = ((FirebaseApplication)getActivity().getApplication()).FirebaseUserAuthenticateId();
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        super.onCreateOptionsMenu(R.menu.edit_profile, menu);
    }

    @Override
    public boolean onOptionsItemSelected(MenuItem item) {
        int id = item.getItemId();
        if(id==R.id.action_edit-profile)
        {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==Helper.SELECT_PICTURE)
        {
            ...
            storageHelper.saveProfileImageToCloud(id,selectedImage,profilePhoto);
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if(requestCode==REQUEST_READ_PERMISSION)
        {
            ...
            {
                Toast.makeText(getActivity(),"Sorry!!! you can't use the app without granting this permission",Toast.LENGTH_SHORT).show();
            }
        }
    }
}
